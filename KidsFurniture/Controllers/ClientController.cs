...
using KidsFurniture.Models.Client;

using KidsFurnitureApp.Core.Contracts;
using KidsFurnitureApp.Core.Services;
...
namespace KidsFurniture.Controllers
{
        ...
        public ActionResult Delete(string id)
        {
            ...
            //Проверка дали потребителя е направил поръчки
            var listOrders = _orderService.GetOrdersByUser(id);
